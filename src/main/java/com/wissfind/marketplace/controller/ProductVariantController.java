...
public class ProductVariantController {
    ...
    public List<ColorVariantResponse> replace(@PathVariable Long productId,
        ...
        // The replace operation deletes the old color rows and immediately inserts
        // new rows with the same (product_id, color) unique key. Force the DELETE
        // to reach the database before Hibernate flushes the INSERTs.
        entityManager.flush();
