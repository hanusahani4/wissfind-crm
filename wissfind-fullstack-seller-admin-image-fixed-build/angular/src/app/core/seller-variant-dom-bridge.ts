...
export class SellerVariantDomBridge {
  ...
  private static template(): string {
    return `
      <style>
        .seller-variant-bridge{grid-column:1/-1;width:100%;min-width:0;margin:18px 0;border:1px solid #e2e5e9;border-radius:14px;padding:16px;background:#fafaf8;display:block}
        ...
        .sv-color{margin-top:14px;background:#fff;border:1px solid #e1e4e8;border-radius:12px;padding:14px;width:100%;min-width:0}
        ...
        .sv-size-head{margin-top:16px}.sv-add-size{border:0;background:transparent;text-decoration:underline;cursor:pointer}.sv-sizes{margin-top:9px;overflow:auto;width:100%}
        .sv-size{display:grid;grid-template-columns:minmax(90px,1fr) minmax(140px,1.5fr) 100px 100px 90px 28px;gap:7px;align-items:center;margin-bottom:7px;min-width:680px}.sv-empty{padding:14px;border:1px dashed #d5d8dd;border-radius:9px;color:#888;font-size:12px;text-align:center;margin-top:14px}
