  ...
  template: `
    <section class="homepage-sections" *ngIf="sections.length">
      <div class="section" *ngFor="let section of sections">
        ...
        <div class="product-row"><div class="customer-section-empty" *ngIf="!(section.products||[]).length">No products available in this section yet.</div>
